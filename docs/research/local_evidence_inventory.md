...
| `ShapeDB.dat` | `2479e9444feaff529313e18a1b26fc2de4f6b6c541db58477da6bebc602164a7` | Reviewed HY-8 implementation evidence; not a primary hydraulic publication |

Release cleanup on 2026-09-09 consolidated all retained evidence under `reference_docs/`
and removed the obsolete `hy8/` directory. It removed byte-identical `HY-8 User's Manual.pdf`,
`Reviewing Coefficients in Embedded Circular Culverts from NCHRP Report 734.pdf`, and
`TFHRCReport.pdf` duplicates before moving the four unique supplemental files listed above.
It also removed the superseded January 2012 `hds5.pdf` and rejected v7.6
`HY-8 QuickTutorial.pdf`. Their hashes and dispositions remain recorded in the CS-001
handoff; the canonical or retained evidence now has one location.
