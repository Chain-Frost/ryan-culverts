...
| CS-021 | Deferred | Unassigned | 2026-09-11 | 2026-09-20 | Use the recorded VS Code/Ruff pinning boundary; add remaining maintenance guidance only when requested. |
