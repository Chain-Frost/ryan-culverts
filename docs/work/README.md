...
| CS-028 | Partial | Unassigned | 2026-09-13 | 2026-09-20 | Review PR for issue #4; run focused/full tests, Ruff, Pyright, docs checks and any desired HY-8 comparison before deciding completion. |
